...
\begin{figure}[!htb]
\begin{center}
  \includegraphics[scale=0.45]{Echantillonneur-bloqueur_ideal.jpg}
...
\begin{figure}[!htb]
      \centering
      \includegraphics[width=0.9\linewidth]{comparateur_schema_cadence_.jpg}
...
\begin{figure}[!htb]
      \centering
      \includegraphics[width=0.9\linewidth]{comparateur_schema_cadence_SR.jpg}
      \caption{Sch\'ema \'electrique}
      \label{fig:schcompSR}
\end{figure}%
...
\begin{figure}[!htb]
\begin{center}
  \includegraphics[scale=0.50]{schema_final.jpg}
